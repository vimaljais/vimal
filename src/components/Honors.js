    ...
    return (
        <div id="honors" className="mt-4 text-white">
            ...
            <div className="flex flex-col md:flex-row mt-4 gap-5">
                <HonorCard name="Who hit the homerun today?" issued="Daffodil Software" desc="Recognized for exceptional commitment and adaptability in mastering new tools and technologies as required by client projects." />
